 ...
 * 2-4 sentence file description here
 This class contains the Ticket class which will be used in a priority queue.
 The tickets will have certain priorities assigned to them based on their
 ticketType and createdAt variables. 
 */
...
public class Ticket implements Comparable<Ticket>{
    ...
    public int compareTo(Ticket other){
        //TODO: Your code
        if(orderMap.get(this.ticketType) == orderMap.get(other.ticketType)){
